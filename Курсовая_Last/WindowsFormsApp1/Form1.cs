    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            groupBox2.Text = "1) Нажмите кнопку \"Загрузить данные\", чтобы загрузить базу данных. \n" +
                  ...
                  "3) При изменении параметров E и A, нужно нажать кнопку 'Сохранение изменений'.";
        ...
        public void Decomposition1(DataGridView dr1, DataGridView dr2)
        {
            ...
            double[,] decomp = new double[dr1.Rows.Count, dr1.Columns.Count];
            dr2.Columns.Clear();
            dr2.Rows.Clear();

            for (int i = 0; i < name.Length; i++)
            {
                dr2.Columns.Add(name[i], name[i]);
                dr2.Columns[i].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
            }
            for (int i = 0; i < dr1.Rows.Count - 1; i++)
            {
                dr2.Rows.Add(dr1.Rows[i].Cells[0].Value);


            }
            dr2.Rows.Add("Прогноз");

            for (int i = 0; i < dr1.Rows.Count - 1; i++) //M и alfa
            {
                for (int j = 1; j < dr1.Columns.Count; j++)
                {
                    M += Math.Pow(Convert.ToDouble(dr1.Rows[i].Cells[j].Value), 2);
                    M_plus += Math.Pow(Convert.ToDouble(dr1.Rows[i].Cells[j].Value) + par_E, 2);
                    M_minus += Math.Pow(Convert.ToDouble(dr1.Rows[i].Cells[j].Value) - par_E, 2);

                    alfa += Convert.ToDouble(dr1.Rows[0].Cells[j].Value) * Convert.ToDouble(dr1.Rows[i].Cells[j].Value);
                    alfa_plus += (Convert.ToDouble(dr1.Rows[0].Cells[j].Value) + par_E) * (Convert.ToDouble(dr1.Rows[i].Cells[j].Value) + par_E);
                    alfa_minus += (Convert.ToDouble(dr1.Rows[0].Cells[j].Value) - par_E) * (Convert.ToDouble(dr1.Rows[i].Cells[j].Value) - par_E);
                ...
                dr2.Rows[i].Cells[1].Value = Math.Round(Math.Sqrt(M), 4);
                dr2.Rows[i].Cells[3].Value = Math.Round(Math.Sqrt(M_plus), 4);
                dr2.Rows[i].Cells[4].Value = Math.Round(Math.Sqrt(M_minus), 4);
                dr2.Rows[i].Cells[2].Value = alfa;
                dr2.Rows[i].Cells[5].Value = alfa_plus;
                dr2.Rows[i].Cells[6].Value = alfa_minus;
                sum_M += Math.Sqrt(M);
            ...
            for (int i = 0; i < dr2.Rows.Count - 2; i++) //M(прогн) и alfa(прогн)
            {
                if (i == 0)
                {
                    M_progn = par_A * Convert.ToDouble(dr2.Rows[0].Cells[1].Value) + (1 - par_A) * (sum_M / (dr2.Rows.Count - 2));
                    M_plus_progn = par_A * Convert.ToDouble(dr2.Rows[0].Cells[3].Value) + (1 - par_A) * (sum_M_plus / (dr2.Rows.Count - 2));
                    M_minus_progn = par_A * Convert.ToDouble(dr2.Rows[0].Cells[4].Value) + (1 - par_A) * (sum_M_minus / (dr2.Rows.Count - 2));
                    dr2.Rows[i].Cells[7].Value = M_progn;
                    dr2.Rows[i].Cells[8].Value = 0;
                    dr2.Rows[i].Cells[9].Value = M_plus_progn;
                    dr2.Rows[i].Cells[10].Value = M_minus_progn;
                    dr2.Rows[i].Cells[11].Value = 0;
                    dr2.Rows[i].Cells[12].Value = 0;
                ...
                {
                    M_progn = par_A * Convert.ToDouble(dr2.Rows[i].Cells[1].Value) + (1 - par_A) * M_progn_prev;
                    alfa_progn = par_A * Convert.ToDouble(dr2.Rows[i].Cells[2].Value) + (1 - par_A) * alfa_progn_prev;
                    M_plus_progn = par_A * Convert.ToDouble(dr2.Rows[i].Cells[3].Value) + (1 - par_A) * M_progn_prev_plus;
                    M_minus_progn = par_A * Convert.ToDouble(dr2.Rows[i].Cells[4].Value) + (1 - par_A) * M_progn_prev_minus;
                    alfa_plus_progn = par_A * Convert.ToDouble(dr2.Rows[i].Cells[5].Value) + (1 - par_A) * alfa_progn_prev_plus;
                    alfa_minus_progn = par_A * Convert.ToDouble(dr2.Rows[i].Cells[6].Value) + (1 - par_A) * alfa_progn_prev_minus;
                    dr2.Rows[i].Cells[7].Value = M_progn;
                    dr2.Rows[i].Cells[8].Value = alfa_progn;
                    dr2.Rows[i].Cells[9].Value = M_plus_progn;
                    dr2.Rows[i].Cells[10].Value = M_minus_progn;
                    dr2.Rows[i].Cells[11].Value = alfa_plus_progn;
                    dr2.Rows[i].Cells[12].Value = alfa_minus_progn;
                    M_progn_prev = M_progn;
                    alfa_progn_prev = alfa_progn;
                    M_progn_prev_plus = M_plus_progn;
                    M_progn_prev_minus = M_minus_progn;
            ...
            for (int i = 0; i < dr2.Rows.Count - 1; i++)
            {
                if (i == 0)
                {
                    M_null = Convert.ToDouble(dr2.Rows[i].Cells[1].Value);
                    R = Math.Abs((Convert.ToDouble(dr2.Rows[i].Cells[1].Value) - M_null) / 2);
                }

                L = Math.Abs(Convert.ToDouble(dr2.Rows[i].Cells[3].Value) - Convert.ToDouble(dr2.Rows[i].Cells[4].Value));
                R = Math.Abs((Convert.ToDouble(dr2.Rows[i].Cells[1].Value) - M_null) / 2);
                dr2.Rows[i].Cells[13].Value = L;
                dr2.Rows[i].Cells[14].Value = R;
                if (R - L == 0)
                {
                    dr2.Rows[i].Cells[15].Value = "Предаварийное";
                }
                if (R > L)
                {
                    dr2.Rows[i].Cells[15].Value = "Нормальное";
                }
                else
                {
                    dr2.Rows[i].Cells[15].Value = "Аварийное";
                }
            ...
            dr2.Rows[dr2.Rows.Count - 2].Cells[7].Value = par_A * (sum_M_progn / (dr2.Rows.Count - 2)) + (1 - par_A) * Convert.ToDouble(dr2.Rows[dr2.Rows.Count - 3].Cells[7].Value);
            Console.WriteLine("Среднее знач M прогн {0}", sum_M_progn / (dr2.Rows.Count - 2));
            Console.WriteLine("Последнее значение {0}", Convert.ToDouble(dr2.Rows[dr2.Rows.Count - 2].Cells[7].Value));
            dr2.Rows[dr2.Rows.Count - 2].Cells[8].Value = par_A * (sum_alfa_progn / (dr2.Rows.Count - 2)) + (1 - par_A) * Convert.ToDouble(dr2.Rows[dr2.Rows.Count - 3].Cells[8].Value);
            dr2.Rows[dr2.Rows.Count - 2].Cells[9].Value = par_A * (sum_Mplus_progn / (dr2.Rows.Count - 2)) + (1 - par_A) * Convert.ToDouble(dr2.Rows[dr2.Rows.Count - 3].Cells[9].Value);
            dr2.Rows[dr2.Rows.Count - 2].Cells[10].Value = par_A * (sum_Mminus_progn / (dr2.Rows.Count - 2)) + (1 - par_A) * Convert.ToDouble(dr2.Rows[dr2.Rows.Count - 3].Cells[10].Value);
            dr2.Rows[dr2.Rows.Count - 2].Cells[11].Value = par_A * (sum_alfaplus_progn / (dr2.Rows.Count - 2)) + (1 - par_A) * Convert.ToDouble(dr2.Rows[dr2.Rows.Count - 3].Cells[11].Value);
            dr2.Rows[dr2.Rows.Count - 2].Cells[12].Value = par_A * (sum_alfaminus_progn / (dr2.Rows.Count - 2)) + (1 - par_A) * Convert.ToDouble(dr2.Rows[dr2.Rows.Count - 3].Cells[12].Value);
            L = Math.Abs(Convert.ToDouble(dr2.Rows[dr2.Rows.Count - 2].Cells[9].Value) - Convert.ToDouble(dr2.Rows[dr2.Rows.Count - 2].Cells[10].Value));
            R = Math.Abs((Convert.ToDouble(dr2.Rows[dr2.Rows.Count - 2].Cells[7].Value) - M_null) / 2);
            dr2.Rows[dr2.Rows.Count - 2].Cells[13].Value = L;
            dr2.Rows[dr2.Rows.Count - 2].Cells[14].Value = R;
            if (R - L == 0)
            {
                dr2.Rows[dr2.Rows.Count - 2].Cells[15].Value = "Предаварийное";
            }
            if (R > L)
            {
                dr2.Rows[dr2.Rows.Count - 2].Cells[15].Value = "Нормальное";
            }
            else
            {
                dr2.Rows[dr2.Rows.Count - 2].Cells[15].Value = "Аварийное";
            }
        ...
        {
            Decomposition1(dataGridView1,dataGridView2);
            Decomposition2();
            }
               ...
               try {
                    for (int x = 0; x < checkedListBox1.Items.Count; x++)
                    {
                        if (checkedListBox1.GetItemChecked(x))
                        {
                            ...
                            {
                                case 0:
                                    CreateSerie(1, 2, "M(alfa)", chart1, true, 1, alpha_minus_min, alpha_plus_max, dataGridView2);
                                    break;
                                case 1:
                                    CreateSerie(3, 5, "M+(alfa+)", chart1, true, 1, alpha_minus_min, alpha_plus_max, dataGridView2);

                                    break;
                                case 2:
                                    CreateSerie(4, 6, "M-(alfa-)", chart1, true, 1, alpha_minus_min, alpha_plus_max, dataGridView2);
                                    break;
                                case 3:
                                    CreateSerie(7, 8, "M_pr(alfa_pr)", chart1, true, 1, alpha_minus_min, alpha_plus_max, dataGridView2);
                                    break;
                                case 4:
                                    CreateSerie(9, 11, "M+_pr(alfa+_pr)", chart1, true, 1, alpha_minus_min, alpha_plus_max, dataGridView2);
                                    break;
                                case 5:
                                    CreateSerie(10, 12, "M-_pr(alfa-_pr)", chart1, true, 1, alpha_minus_min, alpha_plus_max, dataGridView2);
                                    break;
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (comboBox1.SelectedIndex != -1)
            {
                ...
                while(metki[comboBox1.SelectedIndex, k] != 0)
                    {
                        listBox1.Items.Remove(Convert.ToDouble(metki[comboBox1.SelectedIndex, k]));
                        listBox2.Items.Add(metki[comboBox1.SelectedIndex, k]);
                    k++;
                        sort_listbox2();
                    }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                metki[comboBox1.SelectedIndex, listBox2.Items.Count - 1] = Convert.ToInt32(listBox1.SelectedItem);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                metki[comboBox1.SelectedIndex, listBox2.Items.Count - 1] = 0;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < comboBox1.Items.Count - 1; i++)
            {
                ...
                while (metki[i + 1, k1] != 0)
                {
                    kol1++;
                    k1++;
                }
                Console.WriteLine("Кол-во меток  - {0}", kol);
                Console.WriteLine("Кол-во меток1  - {0}", kol1);
                if (kol == kol1)

                { label9.Text = "Одинаковое кол-во меток на блоках"; }

                else
                {
                    label9.Text = "Не одинаковое кол-во меток на блоках";
                    tabPage7.Parent = null;
                }
            }
        }
        ...
        {
            Decomposition1(dataGridView3, dataGridView4);
        }
        ...
        private void checkedListBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            chart3.Series.Clear();
            chart5.Series.Clear();
            charts_init(chart3, alpha_minus_min, alpha_plus_max);
            charts_init(chart5, m_minus_min, m_plus_max);
                ...
                if (checkedListBox2.GetItemChecked(x))
                {
                    ...
                    switch (x)
                    {
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            CreateSerie(0, 1, "M(t)", chart5, true, 1, m_minus_min, m_plus_max, dataGridView4);
                            CreateSerie(0, 3, "M+(t)", chart5, true, 1, m_minus_min,m_plus_max, dataGridView4);
                            CreateSerie(0, 4, "M-(t)", chart5, true, 1, m_minus_min, m_plus_max, dataGridView4);
                            break;
